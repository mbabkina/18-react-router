...
const contacts = [
  {
    ...
    phone: '+380956319521',
    gender: 'male',
    messages: ['Haaaave u met Ted?', 'Suit up!', 'Bros before horse!'],
  },
  {
    id: 223344,
    firstName: 'Робін',
    ...
    phone: '+380931460123',
    gender: 'female',
    messages: ['I miss Canada...', 'Dad, please call me back'],
  },
  {
    id: 0,
    firstName: 'Анонімний',
  ...
  },
  {
    ...
    phone: '+380504691254',
    gender: 'female',
    messages: ['Ouuuuuuuh, son of the ...', 'Hey. did Captain call me?'],
  },
  {
    id: 445566,
    firstName: 'Маршен',
    ...
    phone: '+380739432123',
    gender: 'male',
    messages: ['And put mayo to that salad!', 'Lilypad, I have great news!'],
  },
  {
    id: 556677,
    firstName: 'Теодор',
    ...
    gender: 'male',
    messages: [
      'Hey, did anyone see the blue horn?',
      'And this, kids, is the story of how I met your mother...',
    ],
  },
]
...
class ContactList extends Component {
  ...
  applyFilter = async () => {
    await this.setState(() => {
      ...
      let filtered = this.state.contactsFiltered
        .filter(
          (contact) =>
    ...
    return (
      <main className='wrapper'>
        ...
        <div className='contacts-wrapper'>
          {this.state.contactsFiltered.map(
            (el, i) => (el = <Contact {...this.state.contactsFiltered[i]} />),
          )}
        </div>
      </main>
    )
